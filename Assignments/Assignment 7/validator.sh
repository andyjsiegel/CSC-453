...
FILES=( theory/problem1.json theory/problem1.gv theory/problem2.json  )
HASHES=(   )
echo "==== This is the LigerLabs assignment validator for CSC 453, Assignment 7, Spring 2026 ===="
